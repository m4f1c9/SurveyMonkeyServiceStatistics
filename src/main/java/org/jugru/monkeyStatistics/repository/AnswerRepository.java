...
public interface AnswerRepository extends JpaRepository<Answer, Long> {
    ...
    @Query("Select count(r) from Response r JOIN r.pages p JOIN  p.questions q1 JOIN   q1.answers a1 JOIN p.questions q2 JOIN   q2.answers a2  where a1.choice_id = ?1 and a2.choice_id = ?2 ")
